...
{
	public class SkuVaultApiClient : ISkuVaultClient
	{
		private HttpClient _httpClient;
		private SkuVaultApiClientConfig _apiClientConfig;
		...
		/// <example>
		/// // Pulls configuration from appsettings or environment variables.
